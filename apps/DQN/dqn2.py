        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            if not done:
                target = (reward + self.gamma *
                        np.amax(self.model.predict(next_state, verbose=None)[0]))
...
if __name__ == "__main__":
    ...
    for e in tqdm(range(EPISODES)):
        ...
        while True:
            ...
            next_state, reward, done, ending = env.step(action,number_of_units=n_units, number_of_actions_per_unit=n_actions)
