...
def train_job(idx):
    ...
    agent.q_table.to_csv(get_absolute_path(f"/train_job_results/q_table{idx}.csv"))
...
if __name__ == "__main__":
    for i in tqdm(range(100)):
        ...
        resulting_q_table.to_csv(
            get_absolute_path(
                f"/train_job_results/q_table_merged/q_table{n_epochs}.csv"
            )
        )
